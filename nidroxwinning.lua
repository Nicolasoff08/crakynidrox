if IY_LOADED and not _G.IY_DEBUG == true then
	error("BlackWitcher is already running!",0)
	return
end
...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'BlackWitcher 2.0 is running.'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "BlackWitcher 2.0"..ver
...
PluginsHint.Text = "Download plugins from the BlackW Discord (https://discord.gg/PqmCmHzh3y)"
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		...
		if func then
			func("https://discord.iohttps://discord.gg/PqmCmHzh3y")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.iohttps://discord.gg/PqmCmHzh3y)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- BlackW Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the BlackWitcher support server.'}
	...
	if State == Enum.TeleportState.Started then
		if KeepInfYield == true then
			...
			if queueteleport then
				queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIYhttps://discord.gg/PqmCmHzh3y/master/source'))()")
			end
		end
	end
end)
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	...
	if toClipboard then
		toClipboard('https://discord.gg/PqmCmHzh3y')
		notify('Discord Invite', 'Copied to clipboard!\ndiscord.gg/PqmCmHzh3y')
	else
		notify('Discord Invite', 'discord.gg/PqmCmHzh3y')
	end
...
task.spawn(function()
	if pcall(function() loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIYhttps://discord.gg/PqmCmHzh3y/master/version'))() end) then
		if ver ~= Version then
